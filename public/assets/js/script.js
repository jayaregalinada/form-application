...
Global = angular.module('global', ['ui.bootstrap', 'ngAnimate', 'ngRoute', 'ngUpload']).config(function($interpolateProvider) {
  $interpolateProvider.startSymbol('{#');
  return $interpolateProvider.endSymbol('#}');
});

Global.run(function($rootScope) {
  return $rootScope.header = "Application Form";
});

Global.config(function($routeProvider, $locationProvider) {
  $routeProvider.when("/", {
    templateUrl: "form",
...
Global.controller("doneController", function($scope, $rootScope, $location) {
  $scope.init = function() {
...
Global.controller("formController", function($scope, $http, $rootScope, $location) {
  $scope.original = {
...
Global.directive("validFile", function() {
  return {
    require: "ngModel",
